...
int rock_red_black_tree_rotate_N(struct rock_red_black_tree_node *Y,
                                 bool is_N_left);

int rock_red_black_tree_rotate_N_O(struct rock_red_black_tree_node *Y,
                                   bool is_N_left);
 ...
 */
int rock_red_black_tree_rotate_left(struct rock_red_black_tree_node *node);
 ...
 */
int rock_red_black_tree_rotate_right(struct rock_red_black_tree_node *node);
